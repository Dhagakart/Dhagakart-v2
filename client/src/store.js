...
import { wishlistReducer } from './reducers/wishlistReducer';
import { quoteListReducer, quoteDetailsReducer, newQuoteReducer } from './reducers/quoteReducer';
import { recentOrdersReducer } from './reducers/recentOrdersReducer';
...
let initialState = {
    ...
    sampleCart: {
        sampleCartItems: localStorage.getItem('sampleCartItems') ? JSON.parse(localStorage.getItem('sampleCartItems')) : [],
        sampleShippingInfo: localStorage.getItem("sampleShippingInfo") ? JSON.parse(localStorage.getItem("sampleShippingInfo")) : {},
    },
    saveForLater: {
