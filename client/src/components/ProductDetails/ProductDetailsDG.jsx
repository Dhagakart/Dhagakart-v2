    ...
    <div>
      ...
      <div className="container mx-auto px-0 md:px-16 py-0 md:py-8 mt-0 md:mt-10 pb-4 md:pb-0">
        ...
        <div className="flex flex-col md:flex-row">
          ...
          <div className="md:hidden w-full relative pt-16 mb-0 pb-0">
            <div className="w-full bg-white">
              <div className="w-full relative">
                <Slider ref={mainSlider} {...mainSliderSettings} className="w-full">
                  {product?.images?.map((img, index) => (
                    <div key={index} className="w-full aspect-square flex items-center justify-center bg-white pt-2 pb-0 mb-0">
                      <img
                        src={img?.url || 'https://via.placeholder.com/500'}
                        alt={`${product?.name} - ${index + 1}`}
                        className="w-8/6 h-80 object-contain mx-auto"
                        onError={(e) => {
                          e.target.src = 'https://via.placeholder.com/500';
                        }}
                      />
          ...
          <div className="md:hidden w-full px-4 py-3 bg-white border-t border-gray-200 fixed bottom-0 left-0 right-0 z-50 shadow-lg mt-0">
            ...
            <div className="flex space-x-3 mt-3">
              ...
              <button
                onClick={handleBuyNow}
                className="flex-1 py-2.5 bg-[#003366] text-white font-medium rounded-lg text-sm hover:bg-[#002b57] transition-colors"
              >
                Buy Now
              </button>
            </div>
